...
- **Entitlements File**: `Config/SimpleCalculator.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/SimpleCalculator.entitlements`:
